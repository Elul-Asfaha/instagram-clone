...
const ViewProfile=({loaded,profile}:selfProfileType)=>{
        const [showProfileActionModal, setShowProfileActionModal] = useState<boolean>(false);
                ...
                <div className='w-full flex md:flex-row items-center lg:justify-center md:gap-10'>
                    ...
                    <div className='h-full flex flex-col gap-5'>
                        <div className='flex flex-wrap md:flex-row gap-5 items-center'>
                            ...
                            <button onClick={handleProfileModalOpen} className='flex h-fit md:h-full items-center justify-center p-1'>
                                <BsThreeDots />
                            </button>
                        </div>
                        <div className='hidden md:block'>
